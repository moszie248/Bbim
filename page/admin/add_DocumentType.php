...
<head>
  ...
  <title>เพิ่มข้อมูลประเภทเอกสาร</title>
</head>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">เพิ่มข้อมูลประเภทเอกสาร</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card">
                ...
                <form class="forms-sample" action="Save_add_DocumentType.php" name="frmAdd" method="post">

                <div class="form-group">
                    <label for="exampleInputEmail3">ประเภทเอกสาร</label>
                    <input type="text" class="form-control" name ="name" 
                        placeholder="ประเภทเอกสาร" aria-label="ประเภทเอกสาร" required>
                </div>
