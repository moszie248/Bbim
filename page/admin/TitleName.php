    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">ข้อมูลคำนำหน้าชื่อ</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card-body">
                  <div class="tab-content p-0">
                    ...
                    <div class="form-row justify-content-md-start">
                      <div class="col-2">
                        <button type="submit" class="btn btn-primary" name="up_file" data-toggle="modal" data-target="#add-modal">เพิ่มข้อมูลคำนำหน้าชื่อ</button>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-row justify-content-md-center mt-2">
                  <div class="col-2">
                    คำนำหน้าชื่อ <label class="text-danger">*</label>
                  </div>
                  <div class="col-5">
                    <input type="text" class="form-control" placeholder="คำนำหน้าชื่อ" aria-label="คำนำหน้าชื่อ" required>
                  </div>
