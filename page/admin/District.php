                ...
                <div class="card-body">
                  <div class="tab-content p-0">
                    ...
                    <div class="form-row justify-content-md-start">
                      <div class="col-2">
                        <button type="submit" class="btn btn-primary" name="up_file" data-toggle="modal" data-target="#add-modal">เพิ่มข้อมูลอำเภอ</button>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">เพิ่มข้อมูลอำเภอ</h4>
              ...
              <div class="modal-body">
                <div class="form-row justify-content-md-center mt-2">
                  <div class="col-2">
                  อำเภอ <label class="text-danger">*</label>
                  </div>
                  <div class="col-5">
                    <input type="text" class="form-control" placeholder="อำเภอ" aria-label="อำเภอ" required>
                  </div>
      ...
      <form action="" method="post">
        <div class="modal fade" id="edit-modal">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">แก้ไขข้อมูลอำเภอ</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
