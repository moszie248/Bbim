...
$sql = "SELECT * FROM documenttype WHERE documenttype_id = '".$strID."' ";
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card">
                ...
                <form class="forms-sample" action="Save_edit_DocumentType.php?documenttype_id=<?php echo "$strID" ;?>" name="frmAdd" method="post">

                <div class="form-group">
                    <label for="exampleInputEmail3">ประเภทเอกสาร</label>
                    <input class="form-control" type="text" name="name"
                        value="<?php echo $result["documenttype_name"];?>"></td>
                </div>
