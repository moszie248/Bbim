...
$sql = "SELECT * FROM province WHERE province_id = '".$strID."' ";
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">แก้ไขข้อมูลจังหวัด</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card">
                ...
                <form class="forms-sample" action="Save_edit_Province.php?province_id=<?php echo "$strID" ;?>" name="frmAdd" method="post">

                <div class="form-group">
                    <label for="exampleInputEmail3">จังหวัด</label>
                    <input class="form-control" type="text" name="province_name"
                        value="<?php echo $result["province_name"];?>"></td>
                </div>
