    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">เพิ่มข้อมูลคำนำหน้าชื่อ</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card">
                ...
                <form class="forms-sample" action="Save_TitleName.php" name="frmAdd" method="post">

                <div class="form-group">
                    <label for="exampleInputEmail3">คำนำหน้าชื่อ</label>
                    <input type="text" class="form-control" name ="name" 
                        placeholder="คำนำหน้าชื่อ" aria-label="คำนำหน้าชื่อ" required>
                </div>
