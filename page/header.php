...
<head>
  ...
  <!-- <link rel="stylesheet" href="../Style/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css"> -->
  <!-- Theme style -->
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <!-- <div class="wrapper"> -->
    ...
    <!-- /.navbar -->
<!-- sidebar-dark-primary bg-olive color-palette-->
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="TitleName.php" class="nav-link">
            ...
            <li class="nav-item">
              <a href="Sub-District.php" class="nav-link">
                <i class="nav-icon fas fa-th"></i>
                <p>
                  ข้อมูลตำบล
                </p>
